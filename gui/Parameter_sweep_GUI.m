...
NumberParameterUpdate;
    ...
    function h_edit = initGUI()
        ...
        h_edit.SuppressPlots = uicontrol(bg1,'Style','checkbox','String','Suppress plots',...
            'Value',1,'Units','normalized','Position',[0.3,0.05,0.2,0.1]);
        
        h_edit.PECorPV = uicontrol(bg1,'Style','popupmenu','String',{'PEC','PV (mpp)'},...
            'Value',1,'Units','normalized','Position',[0.05,0.075,0.2,0.05]);
